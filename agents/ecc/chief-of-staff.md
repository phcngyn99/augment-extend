...
- **Rules are system-injected**: `.augment/rules/*.md` files load automatically every session. Unlike prompt instructions, the LLM cannot choose to ignore them.
...
- [Augment Agent](https://docs.anthropic.com/en/docs/claude-code)
