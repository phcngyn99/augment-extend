...
- Skills are organized in two locations:
  - `skills/` - Core skills (28 total), always loaded, mostly symlinked from submodules
...
- All submodules are in `submodule/` directory (12 total: ECC, agent-browser, caveman, codegraph, ponytail, impeccable, obsidian-skills, ppt-master, skills, superpowers, ui-ux-pro-max-skill, destructive-command-guard)
